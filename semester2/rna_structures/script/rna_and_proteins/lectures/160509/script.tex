...
\displaystyle\min_{i<u<j \ k<x<l} \begin{cases} C(i,u;k,x) + A(u,j;x,l) \end{cases}\\
\displaystyle\min_{i<u<j \ k<x<l} \begin{cases} C(i,u;k,x) + M(u+1,j;k+1,x) + A(u,u+1;x,x+1) \end{cases}
\end{cases}
\end{equation}
\begin{equation}
M^1(i,j;k,l) = min
