...
\underline{Neurogene Gene} (1800 Zellen, aber nur 450 werden zu Neuroblasten; Rest epidermale Strukturen -$>$ Funktion besteht darin sicherzustellen, dass keine übermäßige Anzahl von  Neuronen gebildet werden:
\begin{itemize}
